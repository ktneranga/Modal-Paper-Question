...
public class DBHandler extends SQLiteOpenHelper {
    ...
    //implement the method for updateInfo()
    ...
    //create method for delete info
    public void deleteInfo(String username){

        //we need to create a instance of the getWritableDatabase within every crud function
        SQLiteDatabase db = getWritableDatabase();

        // Define 'where' part of query.
        // we are going to delete the record according to the username => username is COLUMN_1
        String selection = UserProfile.Users.COLUMN_1 + " LIKE ?";
    ...
    public List readAllInfo(){
        ...
        String sortOrder =
                UserProfile.Users.COLUMN_1 + " ASC"; //sorting according to the username
        ...
        List usernames = new ArrayList<>(); //usernames is arraylist
    ...
    //create method for searching , it will display the details of paticular user
    //pass the username, cause we are going to search with the username
    public List readAllInfo(String username){
        ...
        // How you want the results sorted in the resulting Cursor
        String sortOrder = UserProfile.Users.COLUMN_1 + " ASC"; //sorting according to the username
